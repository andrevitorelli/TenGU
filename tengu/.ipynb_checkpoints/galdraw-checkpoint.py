...
def exp_gal(gal_flux =  1e5,    # counts
                 gal_r0 = 0.5,       # arcsec
                 pixel_scale = 0.2,  # arcsec / pixel
                 stamp_size = 50):   # pixels
    """Draws a simple round galaxy
    """
    gal = galsim.Exponential(flux=gal_flux, scale_radius=gal_r0)
    gal_image = gal.drawImage(nx=stamp_size,ny=stamp_size, scale=pixel_scale, method='no_pixel').array
    return gal_image

def exp_gal_shear(gal_flux =  1e6,    # counts
                 gal_r0 = 1.0,       # arcsec
                 g1=0,g2=0,
                 pixel_scale = 0.2,  # arcsec / pixel
                 stamp_size = 50):   # pixels
    """Draws a simplem exponential galaxy profile with shear
...
def exp_gal_noise(gal_flux =  1e6,    # counts
                 gal_r0 = 1.0,       # arcsec
                 g1=0,g2=0,
                 pixel_scale = 0.2,  # arcsec / pixel
                 stamp_size = 50,   # pixels
...
def airy_psf(telescope_diameter = 0.02,# metres
            wavelength = 650,         # nm
...
def exp_gal_psf(gal_flux =  1e6,    # counts
                 gal_r0 = 1.0,       # arcsec
                 g1=0,g2=0,
                 pixel_scale = 0.2,  # arcsec / pixel
                 beta =  5,
...
def bulge_disk_gal(bulge_n = 3.5,          # Bulge Sérsic index
                    bulge_re = 2.3,         # arcsec
...
def simulated_gal(  gal_flux = 1.e6,        # ADU  ("Analog-to-digital units", the units of the numbers on a CCD)
            bulge_n = 3.5,          #
            bulge_re = 2.3,         # arcsec
            disk_n = 1.5,           #
            disk_r0 = 0.85,         # arcsec (corresponds to half_light_radius of ~3.7 arcsec)
